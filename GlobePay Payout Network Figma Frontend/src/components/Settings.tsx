            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center justify-between py-4 border-b border-slate-200">
                <div className="space-y-1">
                  ...
                  <div className="text-sm text-slate-600">Get notified when payouts are sent or received</div>
                </div>
              ...
              <div className="flex items-center justify-between py-4 border-b border-slate-200">
                <div className="space-y-1">
                  ...
                  <div className="text-sm text-slate-600">Important compliance and verification updates</div>
                </div>
              ...
              <div className="flex items-center justify-between py-4 border-b border-slate-200">
                <div className="space-y-1">
                  ...
                  <div className="text-sm text-slate-600">Alert when wallet balance falls below threshold</div>
                </div>
              ...
              <div className="flex items-center justify-between py-4">
                <div className="space-y-1">
                  ...
                  <div className="text-sm text-slate-600">Receive a weekly report of your activity</div>
                </div>
                <Switch defaultChecked />
              </div>
            ...
            <div className="space-y-6">
                  ...
                  <div className="p-3 bg-slate-50 rounded-lg border border-slate-200">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <div className="text-xs text-slate-600">San Francisco, CA • Chrome on macOS</div>
                      </div>
              ...
              <div className="py-4">
                <div className="space-y-1 mb-4">
                  ...
                  <div className="text-sm text-slate-600">Manage wallet permissions and security settings</div>
                </div>
              ...
              <div className="p-4 bg-slate-50 rounded-lg border border-slate-200">
                <div className="flex items-center justify-between mb-3">
                  <div>
                    ...
                    <div className="text-xs text-slate-600">https://api.acme.com/webhooks/payouts</div>
                  </div>
                  <span className="text-xs text-green-700 bg-green-100 px-2 py-1 rounded-full">Active</span>
                </div>
