...
const mockTransactions = [
  { id: '1', type: 'sent', amount: 2500, currency: 'USDC', date: '2024-11-14', recipient: 'Maria Garcia' },
  { id: '2', type: 'received', amount: 5000, currency: 'USDC', date: '2024-11-13', recipient: 'Deposit' },
  { id: '3', type: 'sent', amount: 1850, currency: 'EURC', date: '2024-11-13', recipient: 'James Wilson' },
  { id: '4', type: 'converted', amount: 3000, currency: 'USDC', date: '2024-11-12', recipient: 'EURC Conversion' },
];
    ...
    <div className="p-8 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        {mockWallets.map((wallet) => {
          ...
          return (
            <Card key={wallet.id} className="p-6 border-slate-200 bg-gradient-to-br from-white to-slate-50">
              <div className="flex items-start justify-between mb-6">
                <div className={`w-14 h-14 bg-${wallet.color}-100 rounded-2xl flex items-center justify-center`}>
