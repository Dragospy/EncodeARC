    ...
    <div className="p-8 max-w-7xl mx-auto">
      ...
      <div className="mb-8 flex items-center justify-between">
        <div>
          ...
          <p className="text-slate-600">Manage your payout recipients and their verification status</p>
        </div>
        <Dialog open={addOpen} onOpenChange={setAddOpen}>
          ...
          <DialogContent className="max-w-md">
            <DialogHeader>
              ...
              <DialogDescription>
                Add a new recipient to send payouts to
              </DialogDescription>
            </DialogHeader>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
        ...
        <Card className="p-4 border-slate-200">
          ...
          <div className="text-2xl text-slate-900">
            ${Math.round(mockRecipients.reduce((sum, r) => sum + r.totalPaid, 0) / mockRecipients.length).toLocaleString()}
          </div>
        </Card>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {filteredRecipients.map((recipient) => (
          <Card key={recipient.id} className="p-6 border-slate-200 hover:border-blue-300 transition-colors">
            ...
            <div className="mb-4">
              ...
              <div className="space-y-1">
                ...
                <div className="flex items-center gap-2 text-sm text-slate-600">
                  ...
                  <span className="truncate">{recipient.wallet.slice(0, 10)}...{recipient.wallet.slice(-8)}</span>
                </div>
              </div>
            </div>
